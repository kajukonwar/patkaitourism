...
class Fora_Admin {
	...
	public static function hide_notices() {
		if ( isset( $_GET['fora-hide-notice'] ) && isset( $_GET['_fora_notice_nonce'] ) ) {
			if ( ! wp_verify_nonce( $_GET['_fora_notice_nonce'], 'fora_hide_notices_nonce' ) ) {
				wp_die( __( 'Action failed. Please refresh the page and retry.', 'fora' ) );
			}

			if ( ! current_user_can( 'manage_options' ) ) {
				wp_die( __( 'Cheatin&#8217; huh?', 'fora' ) );
			}

			$hide_notice = sanitize_text_field( $_GET['fora-hide-notice'] );
	...
	public function welcome_notice() {
		...
		<div id="message" class="updated cresta-message">
			...
			<p><?php printf( esc_html__( 'Welcome! Thank you for choosing Fora! To fully take advantage of the best our theme can offer please make sure you visit our %swelcome page%s.', 'fora' ), '<a href="' . esc_url( admin_url( 'themes.php?page=fora-welcome' ) ) . '">', '</a>' ); ?></p>
			<p class="submit">
		...
		<div class="cresta-theme-info">
			...
			<div class="welcome-description-wrap">
				...
				<p class="cresta-actions">
					<a href="<?php echo esc_url( 'https://crestaproject.com/downloads/fora/' ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'Theme Info', 'fora' ); ?></a>
			...
			<div class="changelog point-releases">
				<div class="under-the-hood two-col">
					<div class="col">
						...
						<p><a href="<?php echo admin_url( 'customize.php' ); ?>" class="button button-secondary"><?php esc_html_e( 'Customize', 'fora' ); ?></a></p>
					</div>
